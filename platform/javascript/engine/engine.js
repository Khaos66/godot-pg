Function("return this")()["Engine"] = (function() {
    ...
    Engine.prototype.init = /** @param {string=} basePath */ function(basePath) {
        ...
        var config = {};
        if (typeof stdout === "function") config.print = stdout;
        if (typeof stderr === "function") config.printErr = stderr;
        var me = this;
    ...
    Engine.prototype.setOnExecute = function(onExecute) {
        if (this.rtenv) this.rtenv.onExecute = onExecute;
    ...
    Engine.prototype["setWebAssemblyFilenameExtension"] =
        Engine.prototype.setWebAssemblyFilenameExtension;
    ...
    Engine.prototype["setCanvasResizedOnStart"] =
        Engine.prototype.setCanvasResizedOnStart;
    Engine.prototype["setVirtualKeyboardInput"] =
        Engine.prototype.setVirtualKeyboardInput;
    Engine.prototype["setVirtualKeyboardTextArea"] =
        Engine.prototype.setVirtualKeyboardTextArea;
